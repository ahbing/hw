...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <title>HW官网</title>
<head>
<script src="/HW/HW/Public/Home/js/jquery.min.js"></script>
<script src="/HW/HW/Public/Home/js/bootstrap.min.js"></script>
<link href="/HW/HW/Public/Home/css/bootstrap.min.css" rel="stylesheet">
<script src="/HW/HW/Public/Home/js/index.js"></script>
<link href="/HW/HW/Public/Home/css/index.css" rel="stylesheet">
 <link rel="stylesheet" href="/HW/HW/Public/Home/css/product.css" />
</head>
<body>
<nav class="naver-default  navbar-fixed-top" >
    ...
    <div  id="bs-example-navbar-collapse-1">
      <img src="/HW/HW/Public/home/images/logo.png" />
 ...
 <!--首页-->     
    <div class="section section-1" >
           <img class="backgroundImg" src="/HW/HW/Public/Home/images/background1.jpg"/>
    </div>
...
<div class="carousel-inner" style="height:100%;" >
       <!--第一页-->   
          <div class="item active"  style="height:100%;">
            <img class="backgroundImg" src="/HW/HW/Public/Home/images/HWIntroduce1.jpg"   alt="1" >
       ...
       <!--第二页-->
          <div class="item"   style="height:100%;">
             <img class="backgroundImg" src="/HW/HW/Public/Home/images/HWIntroduce2.jpg"  alt="2">  
       ...
       <!--第三页-->  
          <div class="item" style="height:100%;">
             <img class="backgroundImg" src="/HW/HW/Public/Home/images/HWIntroduce1.jpg"  alt="3"> 
...
<div class="section section-3">
   <img class="backgroundImg" src="/HW/HW/Public/Home/images/HWIntroduce1.jpg"  >
<div class="foucebox">
  <div class="bd">
    <div class="showDiv"> <a href="#"><img src="/HW/HW/Public/Home/images/1.6.jpg"></a>
  ...
  <div class="hd">
    <ul>
      <li class="on"><a href="#"><img src="/HW/HW/Public/Home/images/6.jpg"><span class="txt">标题</span><span class="txt_bg"></span><span class="mask"></span></a></li>
      <li><a href="#"><img src="/HW/HW/Public/Home/images/6.jpg"><span class="txt">标题</span><span class="txt_bg"></span><span class="mask"></span></a></li>
      <li><a href="#"><img src="/HW/HW/Public/Home/images/6.jpg"><span class="txt">标题</span><span class="txt_bg"></span><span class="mask"></span></a></li>
      <li><a href="#"><img src="/HW/HW/Public/Home/images/6.jpg"><span class="txt">标题</span><span class="txt_bg"></span><span class="mask"></span></a></li>
      <li><a href="#"><img src="/HW/HW/Public/Home/images/6.jpg"><span class="txt">标题</span><span class="txt_bg"></span><span class="mask"></span></a></li>
      <li><a href="#"><img src="/HW/HW/Public/Home/images/6.jpg"><span class="txt">标题</span><span class="txt_bg"></span><span class="mask"></span></a></li>
...
<script type="text/javascript" src="/HW/HW/Public/Home/js/jquery.SuperSlide.js"></script> 
...
<!--社团动态开始-->   
 <div class="section section-4">
         <img class="backgroundImg" src="/HW/HW/Public/Home/images/orgAct.jpg"/>
          ...
          <!--一个大的DIV随鼠标移动内容变化-->  
          <div id="timerWindow"><img src="/HW/HW/Public/Home/images/ActPhoto1.jpg"><!-- 后台此处加图 -->
...
<!--合作伙伴开始-->    
 <div class="section section-5">
   <img class="backgroundImg" src="/HW/HW/Public/Home/images/HWIntroduce1.jpg"  >
  <script type="text/javascript" src="/HW/HW/Public/Home/js/jQuery-easing.js"></script>
  <script type="text/javascript" src="/HW/HW/Public/Home/js/jQuery-jcImgScroll.js"></script>

<link rel="stylesheet" type="text/css" href="/HW/HW/Public/Home/css/partner.css">
  <div id="demo3" class="jcImgScroll" style="position:absolute;top:100px;left:550px;">
  <ul>
    <li><a href="#" path="/HW/HW/Public/Home/images/1.jpg"></a></li>
    <li><a href="#" path="/HW/HW/Public/Home/images/1.jpg"></a></li>
    <li><a href="#" path="/HW/HW/Public/Home/images/1.jpg"></a></li>
    <li><a href="#" path="/HW/HW/Public/Home/images/1.jpg"></a></li>
    <li><a href="#" path="/HW/HW/Public/Home/images/1.jpg"></a></li>
...
<img class="backgroundImg" src="/HW/HW/Public/Home/images/joinUs.jpg" />
  <div class="title">
